...
// // // // import { useAuthStore } from '../store/authStore';
// // // // import { PathResult, ExerciseEntry, NextExerciseResponse,Exercise, Category } from '../types'; // ודא שייבאת את ה-types הנכונים
...
// // // //   const[category, setCategory] = useState<Category[]>([]); // הוסף קטגוריה לתרגילים
...
// // // //   useEffect(() => {
// // // //     fetchExercises(); // טען את כל התרגילים
// // // //     fetchCategory();
// // // //     fetchWorkoutStatus();
...
// // // //           {/* שימוש בפונקציית העזר לשם התרגיל */}
// // // //           {/* תרגיל נוכחי: {getExerciseName(currentExercise.exerciseId)} */}
// // // //         </h2>
// // // //         {/* שינוי לסדר הנכון מתוך ExerciseEntry */}
...
// // // //         {/* **** כאן תוסיפי את הצגת הסטים, חזרות וזמנים **** */}
// // // //         {/* קודם כל, נמצא את ה-ExercisePlan המתאים לתרגיל הנוכחי */}
// // // //         {(() => {
...
// // // //                 <p className='text-'>category: {category.find(e => e.categoryId ===currentExercisePlan.categoryId)?.categoryName} </p>
...
// // // //             );
// // // //           }
// // // //           return null; // אם אין פרטי תוכנית
// // // //         })()}

// // // //         <div className="mt-4 flex gap-4">
// // // //           {/* ... כפתורי התחלה/סיום - נשארים כפי שהם */}
...
// // // //         <div className="bg-blue-50 border-l-4 border-blue-400 p-4 mb-6 rounded-md">
// // // //           <h2 className="text-xl font-semibold text-blue-800 mb-2">תרגיל נוכחי: {currentExercise.exerciseDetails?.exercise?.exerciseName}</h2>
// // // //           <p className="text-gray-700">סדר בתרגילים: {currentExercise.orderInList + 1} מתוך {workoutData.exerciseIdsInPath ? Object.keys(workoutData.exerciseIdsInPath).length : '?'}</p>
// // // //            */}
// // // //           {/* הוסף כאן פרטים נוספים מה-currentExercise כגון סטים, חזרות, זמן מנוחה */}
...
// // // //            {/* **** הצגת פרטי התרגיל מתוך ExercisePlanDetails **** */}
// // // //              {/* {currentExercise.exerciseDetails && (
// // // //                 <>
// // // //               <p className="text-gray-700">סטים: {currentExercise.exerciseDetails.sets}</p>
// // // //                 <p className="text-gray-700">חזרות: {currentExercise.exerciseDetails.reps}</p>
// // // //                 {currentExercise.exerciseDetails.weight !== undefined && (
// // // //               <p className="text-gray-700">משקל: {currentExercise.exerciseDetails.weight} ק"ג</p>
// // // //               )}
// // // //               {currentExercise.exerciseDetails.restTime && (
// // // //                 <p className="text-gray-700">זמן מנוחה: {currentExercise.exerciseDetails.restTime} שניות</p>
// // // //                 )}
// // // //                 </>
// // // //                 )}
// // // //               *************************************************************** */}
...
// // // //               // key={exercise.exerciseId + '-' + exercise.exerciseDetails?.exerciseName} // מפתח ייחודי לכל פריט ברשימה
// // // //               className={`flex items-center justify-between p-3 rounded-md ${
...
// // // import React, { useState, useEffect, useCallback } from 'react';
// // // import { useParams, useNavigate } from 'react-router-dom';
// // // import { motion, AnimatePresence } from 'framer-motion'; // ייבא AnimatePresence לאנימציות מודאל
// // // import { CheckCircle } from 'lucide-react'; // ייבא CheckCircle לאייקון הצלחה
// // // import Button from '../components/ui/Button';
// // // import { activeWorkoutApi, categoryApi, exerciseApi } from '../lib/api';
// // // import { useAuthStore } from '../store/authStore';
...
// // //   const [error, setError] = useState<string | null>(null);
// // //   const [isWorkoutComplete, setIsWorkoutComplete] = useState(false);
// // //   const [showWorkoutCompleteModal, setShowWorkoutCompleteModal] = useState(false); // **חדש: מצב לשליטה במודאל סיום אימון**
// // //   const [exercises, setExercises] = useState<Exercise[]>([]);
...
// // //       // **חדש: אם האימון הושלם, הצג את המודאל**
// // //       if (updatedWorkout.isWorkoutComplete) {
// // //         setShowWorkoutCompleteModal(true);
// // //         setCurrentExercise(null); // נקה את התרגיל הנוכחי
// // //       } else {
// // //         const nextExerciseRes: NextExerciseResponse = await activeWorkoutApi.getNextExerciseInWorkout(traineeId);
// // //         
// // //         if (nextExerciseRes.isWorkoutComplete) {
// // //           setIsWorkoutComplete(true);
// // //           setShowWorkoutCompleteModal(true); // **חדש: הצג מודאל אם ה-Backend מציין השלמה כאן**
// // //           setCurrentExercise(null);
// // //         } else {
// // //           setCurrentExercise(nextExerciseRes.nextExercise || null);
// // //         }
...
// // //       if (err.response && err.response.status === 404) {
// // //         setIsWorkoutComplete(true);
// // //         setShowWorkoutCompleteModal(true); // **חדש: הצג מודאל אם 404 מרמז על השלמה**
// // //         setCurrentExercise(null);
// // //         // alert('האימון הסתיים או לא נמצא במערכת. חוזרים לדף הבית.'); // הסר התראה ישירה
// // //         // navigate('/'); // הסר ניווט ישיר
// // //       } else {
// // //         setError(err.response?.data?.message || err.message || 'שגיאה בטעינת סטטוס האימון.');
// // //       }
// // //     } finally {
...
// // //   // **חדש: פונקציה לטיפול בכפתור "חזור לדף הבית" מהמודאל**
// // //   const handleGoHome = () => {
// // //     setShowWorkoutCompleteModal(false); // סגור את המודאל
...
// // //   // **חשוב: הסר את הבלוק הזה, שכן המודאל יטפל כעת בתצוגת ההשלמה**
// // //   // if (isWorkoutComplete) {
// // //   //   return (
// // //   //     <div className="text-center py-8 text-green-600">
// // //   //       <h2 className="text-2xl font-bold mb-4">כל הכבוד! האימון הושלם בהצלחה!</h2>
...
// // //   if (!workoutData && !isWorkoutComplete) { // בדוק גם !isWorkoutComplete כאן
// // //     return (
// // //       <div className="text-center py-8 text-gray-500">
// // //         לא נמצא אימון פעיל או שהתרגיל הבא לא זמין.
// // //         <Button onClick={() => navigate('/')} className="mt-4">חזור לדף הבית</Button>
...
// // //               <>
// // //                 <p className="text-gray-700">id: {currentExercisePlan.exerciseId}</p>
// // //                 <p className='text-gray-700'>קטגוריה: {category.find(e => e.categoryId === currentExercisePlan.categoryId)?.categoryName} </p>
// // //                 <p className="text-gray-700">סטים: {currentExercisePlan.planSets}</p>
// // //                 <p className="text-gray-700">חזרות: {currentExercisePlan.planRepetitionsMin} - {currentExercisePlan.planRepetitionsMax}</p>
// // //                 {currentExercisePlan.planWeight !== undefined && (
// // //                   <p className="text-gray-700">משקל: {currentExercisePlan.planWeight} ק"ג</p>
...
// //     const [exercises, setExercises] = useState<Exercise[]>([]);
// //     const [categories, setCategories] = useState<Category[]>([]); // שינוי שם המשתנה ל-categories
// //     // **חדש: משתנה מצב לטריגר רענון**
...
// //     const fetchCategories = async () => { // שינוי שם הפונקציה ל-fetchCategories
// //         try {
// //             setIsLoading(true);
// //             setError(null);
// //             const data = await categoryApi.getAll();
// //             setCategories(data); // עדכון categories
// //         } catch (error) {
// //             setError(String(error));
// //         } finally {
// //             setIsLoading(false);
...
// //             console.error('Error fetching workout status:', err);
// //             if (err.response && err.response.status === 404) {
// //                 // אם קיבלנו 404, זה יכול להעיד על אימון שהושלם או לא נמצא
// //                 setIsWorkoutComplete(true);
// //                 setShowWorkoutCompleteModal(true); 
// //                 setCurrentExercise(null);
// //             } else {
...
// //             setIsLoading(false);
// //         }
// //     }, [traineeId, planDayId]); // planDayId לא נחוץ כאן ל-callback, אבל לא מזיק
...
// //     // useEffect(() => {
// //     //     fetchExercises();
// //     //     fetchCategories(); // קריאה לפונקציה המעודכנת
// //     //     fetchWorkoutStatus();
// //     // }, [fetchWorkoutStatus]);
// //     useEffect(() => {
// //     fetchExercises();
// //     fetchCategories();
// //     fetchWorkoutStatus();
// // }, [fetchWorkoutStatus, refreshTrigger]); // הוספנו את refreshTrigger כתלות
...
// //             await activeWorkoutApi.startExercise(traineeId, exerciseId, currentTime);
// //             alert('התרגיל התחיל!');
// //             // רענן את סטטוס האימון בדף הנוכחי
...
// //     // פונקציה לטיפול בכפתור "חזור לדף הבית" מהמודאל
// //     const handleGoHome = () => {
// //         setShowWorkoutCompleteModal(false); // סגור את המודאל
// //         navigate('/'); // נווט לדף הבית
// //     };
...
//     // **חדש: השתמש ב-Hook החדש כדי לקבל את refreshCounter**
...
//     //     fetchCategories(); 
//     //     fetchWorkoutStatus();
//     //     // **שינוי: הוספת refreshCounter כתלות**
//     //     // כאשר refreshCounter משתנה (מ-TraineeWorkoutCard), ה-useEffect יופעל מחדש
//     // }, [fetchWorkoutStatus, refreshCounter]); 
//      useEffect(() => {
//          if (traineeId && planDayId && planDayId !== 0) {
//              const interval = setInterval(() => {
//                 // We don't set isLoading here to avoid UI flickering
//                  fetchWorkoutStatus();
//          }, 5000); // Poll every 5 seconds

//             return () => clearInterval(interval); // Clean up on component unmount
//          }
//     }, [traineeId, planDayId, fetchWorkoutStatus, refreshCounter]); // Added refreshCounter here as well


//     // הפונקציות handleStartExercise ו-handleCompleteExercise בדף הזה
//     // אינן צריכות לקרוא ל-setRefreshTrigger() כאן, מכיוון שהן כבר קוראות ל-fetchWorkoutStatus() ישירות,
//     // וזה מעדכן את ה-state של הדף. הטריגר הגלובלי מיועד לתקשר בין דפים שונים.
//     const handleStartExercise = async (exerciseId: number) => {
//         if (!traineeId || !currentExercise) return;
//         try {
//             const currentTime = new Date();
//             await activeWorkoutApi.startExercise(traineeId, exerciseId, currentTime);
//             // alert('התרגיל התחיל!');
//             await fetchWorkoutStatus(); // עדכן את המצב בדף זה
//         } catch (err: any) {
//             console.error('Failed to start exercise:', err);
//             alert(`שגיאה בהתחלת תרגיל: ${err.response?.data?.message || err.message}`);
//         }
