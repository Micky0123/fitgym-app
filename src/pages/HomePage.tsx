...
// // // import { useNavigate } from 'react-router-dom';
// // // import { motion } from 'framer-motion';
// // // // ייבא גם List, CircleDotDashed (או icon אחר), XCircle, CheckCircle, Weight, Repeat
// // // import { Play, Calendar, History, Edit, ChevronUp, ChevronDown, Loader2, LayoutDashboard, List, CircleDotDashed, XCircle, CheckCircle, Weight, Repeat } from 'lucide-react'; 
// // // import Button from '../components/ui/Button';
// // // import { useAuthStore } from '../store/authStore';
// // // import { getImageUrl } from '../lib/utils';
// // // // ודא שאתה מייבא את exercisePlanApi אם הוא לא קיים
// // // import { trainingPlanApi, authApi, activeWorkoutApi, exercisePlanApi } from '../lib/api'; 
// // // import { formatApiError } from '../lib/utils';
// // // import axios from 'axios';
...
// // //     ActiveTrainingPlanResponse,
// // //     MultiplePlansResponseItem,
// // //     ExercisePlan, // <--- ייבא את הטיפוסים המדויקים שלך
// // //     Exercise,     // <--- ייבא גם את Exercise
// // // } from '../types';
// // // import type { TrainingPlan } from '../types';
...
// // //         // אם התרגילים כבר נטענו עבור היום הזה, פשוט החלף את מצב ההרחבה
...
// // //             // **עדכן את ה-state החדש שמכיל את התרגילים לפי planDayId**
...
// // //     const togglePlanExpansion = (planId: number) => {
// // //         setExpandedPlanId(expandedPlanId === planId ? null : planId);
// // //         // כשמרחיבים/מצמצמים תוכנית אימון, נסגור גם את הרחבת ימי האימון בתוכה
// // //         setExpandedDayId(null); 
// // //         setExercisesByPlanDayId({}); // נקה את מטמון התרגילים של ימי האימון הקודמים
// // //     };

// // //     // פונקציה חדשה לרינדור כפתור יום אימון עבור תוכניות היסטוריות
// // //     const renderHistoryPlanDayButton = (day: PlanDay) => {
// // //         const isCurrentlyLoadingExercises = isLoadingExercisesForDay === day.planDayId;
// // //         const isExpanded = expandedDayId === day.planDayId;
// // //         const dayExercises = exercisesByPlanDayId[day.planDayId]; // קבל את התרגילים מהמטמון
...
// // //                                     <span>
// // //                                         **{ exercisePlan.exercise?.exerciseName|| 'שם תרגיל לא ידוע'}**: {exercisePlan.planSets} סטים | {exercisePlan.planRepetitionsMin}-{exercisePlan.planRepetitionsMax} חזרות | {exercisePlan.planWeight} ק"ג
// // //                                     </span>
// // //                                 </li>
// // //                             ))}
// // //                         </ul>
...
// // //                             className="text-blue-600 hover:text-blue-700"
// // //                             icon={isCurrentlyLoadingExercises ? <Loader2 className="h-4 w-4 animate-spin" /> : isExpanded ? <ChevronUp className="h-4 w-4" /> : <List className="h-4 w-4" />}
// // //                             disabled={isCurrentlyLoadingExercises || isWorkoutStarting} // אל תאפשר פתיחה בזמן התחלת אימון
// // //                         >
// // //                             {isCurrentlyLoadingExercises ? 'טוען...' : isExpanded ? 'הסתר תרגילים' : 'הצג תרגילים'}
// // //                         </Button>
// // //                         <Button
...
// // //                                             return renderActivePlanDayButton(day);
// // //                                         } else {
// // //                                             // שימוש בפונקציה החדשה עבור תוכניות היסטוריות
// // //                                             return renderHistoryPlanDayButton(day); 
// // //                                         }
// // //                                     })}
// // //                             </div>
// // //                         </motion.div>
// // //                     )}
// // //                     {expandedPlanId === planInfo.trainingPlanId && (!planDays || planDays.length === 0) && (
// // //                         <div className="mt-4 text-center text-gray-500">אין ימי אימון בתוכנית זו.</div>
// // //                     )}
...
// // //                                 עדכון פרטים אישיים
// // //                             </Button>
// // //                             {/* ** הוספת כפתור לוח מחוונים של המתאמן ** */}
// // //                             <Button
// // //                                 variant="outline"
// // //                                 onClick={() => navigate('/trainee-dashboard')}
// // //                                 icon={<LayoutDashboard className="h-4 w-4" />}
...
// // import { useAuthStore } from '../store/authStore';
// // import { getImageUrl } from '../lib/utils';
// // import { trainingPlanApi, authApi, activeWorkoutApi, exercisePlanApi, exerciseApi } from '../lib/api'; // <--- ודא ש-exerciseApi מיובא
// // import { formatApiError } from '../lib/utils';
// // import axios from 'axios';
...
// //     MultiplePlansResponseItem,
// //     ExercisePlan,
// //     Exercise, // <--- ודא ש-Exercise מיובא גם כאן
// // } from '../types';
// // import type { TrainingPlan } from '../types';
...
// //     // **המצב החדש לאחסון כל התרגילים במפה (Map) עבור חיפוש מהיר**
...
// //         fetchAllExercises();
// //     }, []); // רץ רק פעם אחת בטעינת הקומפוננטה
...
// //             <div key={day.planDayId} className="bg-gray-50 p-3 rounded-md">
// //                 <div className="flex items-center justify-between">
// //                     <span className="text-gray-700">{`יום ${day.dayOrder}`}</span>
// //                     <Button
// //                         onClick={() => fetchExercisesForDay(day.planDayId)}
// //                         size="sm"
// //                         variant="ghost"
...
// //                                     <CircleDotDashed className="h-4 w-4 text-green-500 ml-2 flex-shrink-0" />
// //                                     <span>
// //                                         {getExerciseName(exercisePlan.exerciseId)}: {exercisePlan.planSets} סטים | {exercisePlan.planRepetitionsMin}-{exercisePlan.planRepetitionsMax} חזרות | {exercisePlan.planWeight} ק"ג
// //                                     </span>
// //                                 </li>
// //                                 // <li key={exercisePlan.exercisePlanId} className="flex items-center text-sm text-gray-800">
// //                                 //     <CircleDotDashed className="h-4 w-4 text-green-500 ml-2 flex-shrink-0" />
...
// //         isCurrent: boolean
// //     ) => {
// //         // ... (הקוד הקיים שלך עבור renderPlanCard)
// //         const planInfo = planData as TrainingPlan;
...
// //                     <div className="p-4 sm:p-6">
// //                         {isLoading || isLoadingAllExercises ? ( // <--- הוספנו תנאי טעינה לכל התרגילים
// //                             <div className="text-center py-8 text-gray-500">טוען...</div>
// //                         ) : error ? (
// //                             <div className="text-center text-red-500 py-8">{error}</div>
// //                         ) : activeSection === 'current' ? (
...
//     const [expandedPlanId, setExpandedPlanId] = useState<number | null>(null);
//     // שינוי כאן: expandedDayId צריך להיות מפתח אובייקט עבור כל תוכנית אימונים, או שפשוט נאפשר הרחבת יום אחד בכל פעם.
//     // מכיוון שכבר יש לך `exercisesByPlanDayId` שהוא מפת מזהה יום לתרגילים, הגיוני ש-`expandedDayId` ישאר עבור יום יחיד.
//     const [expandedDayId, setExpandedDayId] = useState<number | null>(null);
//     const [isLoadingExercisesForDay, setIsLoadingExercisesForDay] = useState<number | null>(null);
//     const [exercisesByPlanDayId, setExercisesByPlanDayId] = useState<Record<number, ExercisePlan[]>>({});
...
//             // נרצה להפריד בין ימי תוכנית רגילים לימי היסטוריית אימונים
//             const processedHistoryPlans = historyResponse.map(planItem => {
//                 const regularDays = planItem.planDays.filter(day => !day.isHistoricalProgram)
//                                                     .sort((a, b) => a.dayOrder - b.dayOrder);
//                 const historicalDays = planItem.planDays.filter(day => day.isHistoricalProgram)
//                                                         .sort((a, b) => new Date(b.creationDate).getTime() - new Date(a.creationDate).getTime()); // ממיין מהחדש לישן

//                 return {
//                     ...planItem,
//                     planDays: [...regularDays, ...historicalDays] // משלב אותם, רגילים קודם
//                 };
//             });
...
//     // פונקציה חדשה לרינדור כפתור יום אימון עבור תוכניות היסטוריות
//     // 💡 שיניתי את הפרמטרים כך שתקבל גם את ה-`trainingPlan` כדי להציג את התאריך
//     const renderHistoryPlanDayButton = (day: PlanDay, trainingPlan: TrainingPlan) => {
//         const isCurrentlyLoadingExercises = isLoadingExercisesForDay === day.planDayId;
//         const isExpanded = expandedDayId === day.planDayId;
//         const dayExercises = exercisesByPlanDayId[day.planDayId];

//         // 💡 שינוי: הצגת שם התוכנית והתאריך עבור ימי היסטוריה
...
//         // 💡 שינוי: מיון ימי האימון בתוך ה-render
